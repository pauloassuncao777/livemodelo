...
<body>
    ...
    <div class="header">
        <div class="logo-container">
            ...
            <div class="profile-info">
                <img src="/perfilll6.svg" alt="Júlia Laís" class="profile-pic">
                <div class="profile-text">
                    <div class="profile-name">Júlia</div>
    ...
    <div class="video-container">
        ...
        <img id="loadingGif" src="/carregando6.gif" alt="Carregando..." style="width: 100%; height: 100%; object-fit: cover; z-index: 2;">
        ...
        <video id="liveVideo" playsinline autoplay muted style="display: none; width: 100%; height: 100%; object-fit: cover; z-index: 1;">
            <source src="/live6.mp4" type="video/mp4">
        </video>
    </div>
    ...
    <div class="bottom-controls">
        <div class="interaction-buttons">
            <button class="interaction-button" id="likeButton">
                ...
                <span class="interaction-count" id="likes-count">1721</span>
            </button>
        </div>
