...
<body>
    ...
    <div class="header">
        <div class="logo-container">
            ...
            <div class="profile-info">
                <img src="/menu/foto10.svg" alt="Júlia Laís" class="profile-pic">
    ...
    <div class="video-container">
        ...
        <img id="loadingGif" src="/carregando-7.gif" alt="Carregando..." style="width: 100%; height: 100%; object-fit: cover; z-index: 2;">
        ...
        <video id="liveVideo" playsinline autoplay muted style="display: none; width: 100%; height: 100%; object-fit: cover; z-index: 1;">
            <source src="/live-tamirys.mp4" type="video/mp4">
        </video>
    </div>
