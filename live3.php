...
<body>
    ...
    <div class="header">
        <div class="logo-container">
            ...
            <div class="profile-info">
                <img src="/menu/foto2.svg" alt="Amanda Lopes" class="profile-pic">
    ...
    <div class="video-container">
        ...
        <img id="loadingGif" src="/carregando3.gif" alt="Carregando..." style="width: 100%; height: 100%; object-fit: cover; z-index: 2;">
