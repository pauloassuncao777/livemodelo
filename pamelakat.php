    ...
    <style>
        ...
        * {
        ...
        .profile-name {
                ...
                max-width: 100px; /* Ajuste conforme necessário ou use `calc()` */
...
<body>
    ...
    <div class="header">
        <div class="logo-container">
            ...
            <div class="profile-info">
                <img src="/menu/foto8.svg" alt="PAMELAKAT" class="profile-pic">
                <div class="profile-text">
                    <div class="profile-name">PAMELAKAT</div>
                    <div class="viewers-count">
                        <i class="fas fa-eye"></i> <span id="vip-counter">5</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="header-actions">
            ...
            <button class="vip-button" id="buyVipButton">
                <img src="/menu/gift.svg" alt="Coroa VIP" width="30" height="30" style="vertical-align: middle; margin-right: 8px;">
                ENVIAR
                </button>
        </div>
    </div>
    ...
    <div class="video-container">
        ...
        <img id="loadingGif" src="/carregando-10.gif" alt="Carregando..." style="width: 100%; height: 100%; object-fit: cover; z-index: 2;">
        ...
        <video id="liveVideo" playsinline autoplay muted style="display: none; width: 100%; height: 100%; object-fit: cover; z-index: 1;">
            <source src="/live/live-pamela.mp4" type="video/mp4">
        </video>
    </div>
    ...
    <div class="bottom-controls">
        <div class="interaction-buttons">
            <button class="interaction-button" id="likeButton">
                ...
                <span class="interaction-count" id="likes-count">14</span>
            </button>
        </div>
    ...
    <script>
        ...
        let vipCount = 5; // Changed from 85 to 3
        let likesValue = 13;
