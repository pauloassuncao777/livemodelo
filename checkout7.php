...
<body>
    ...
    <div class="video-container">
        ...
        <!-- Canvas para renderizar o vídeo -->
        <canvas id="videoCanvas" style="width: 100%; height: 100%; object-fit: cover; z-index: 1;"></canvas>
        
        <!-- Vídeo oculto (usado apenas para áudio e fonte de frames) -->
        <video id="liveVideo" playsinline autoplay muted style="position: absolute; width: 1px; height: 1px; opacity: 0; pointer-events: none; top: -9999px; left: -9999px;">
    ...
    <script>
        ...
        // Variáveis para controle de animação do canvas
        let animationFrameId = null;
        
        // Function to render video frames to canvas
        function renderVideoToCanvas() {
            if (liveVideo.readyState >= liveVideo.HAVE_CURRENT_DATA) {
                // Ajuste as dimensões do canvas para corresponder ao vídeo
                if (videoCanvas.width !== liveVideo.videoWidth || videoCanvas.height !== liveVideo.videoHeight) {
                    videoCanvas.width = liveVideo.videoWidth;
                    videoCanvas.height = liveVideo.videoHeight;
                }
                
                // Desenha o quadro atual do vídeo no canvas
                ctx.drawImage(liveVideo, 0, 0, videoCanvas.width, videoCanvas.height);
            }
            
            // Continue renderizando apenas se o vídeo estiver em execução
            if (!liveVideo.ended && !liveVideo.paused) {
        ...
        function setupEventListeners() {
            ...
            // Video ended event - adaptado para funcionar com o canvas
        ...
        function enableAudio() {
            // Hide the loading GIF and show canvas
            ...
            // Adicionar classe 'active' ao canvas
            videoCanvas.classList.add('active');
            
            // Iniciar a renderização do canvas
            renderVideoToCanvas();
        ...
        // Function to make camera draggable
