...
<body>
    ...
    <div class="header">
        <div class="logo-container">
            ...
            <div class="profile-info">
                <img src="../perfilll4.svg" alt="Larissa" class="profile-pic">
                <div class="profile-text">
                    <div class="profile-name">Larissa</div>
    ...
    <div class="video-container">
        ...
        <img id="loadingGif" src="/carregando4.gif" alt="Carregando..." style="width: 100%; height: 100%; object-fit: cover; z-index: 2;">
        ...
        <video id="liveVideo" playsinline autoplay muted style="display: none; width: 100%; height: 100%; object-fit: cover; z-index: 1;">
            <source src="/live4.mp4" type="video/mp4">
        </video>
    </div>
