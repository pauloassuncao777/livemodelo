...
$onlineRedirectUrls = [
    'JÉSSICA' => 'https://livemodelo.com/live6.php?id=14.70',
    'AMANDA' => 'https://livemodelo.com/live3.php?id=24.70',
    'MARIA DUDA' => 'https://livemodelo.com/live2.php?id=17.40',
    'LARISSA' => 'https://livemodelo.com/live4.php?id=9.70',
    'BIANCA' => 'https://livemodelo.com/checkout6.php?id=19.70'
];
...
$profileData = [
    ...
    'CAROLINA LIMA' => [
        'fullName' => 'Carolina Lima Ferreira',
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            .profiles {
                grid-template-columns: repeat(auto-fill, minmax(180px, 50%));
            }
            ...
            .profile-popup-avatar {
                width: 130px; /* Ajustado para responsividade */
                height: 130px; /* Ajustado para responsividade */
                margin: -65px auto 0;
            }
            
            /* Improve profile link visibility */
            .profile-header {
                padding: 10px 12px;
            }
        ...
        @media (max-width: 576px) {
            ...
            .profile-popup-avatar {
                width: 120px; /* Ajustado para responsividade */
                height: 120px; /* Ajustado para responsividade */
                margin: -60px auto 0;
            }
            ...
            /* Improve profile link visibility for small screens */
            .profile-header {
                padding: 8px 10px; 
...
<body>
    ...
    <script>
        ...
        // Make responsive grid on resize
        window.addEventListener('resize', function() {
            ...
            if (activeViewOption) {
                ...
                // Apply grid size based on viewport width
