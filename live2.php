...
<body>
    ...
    <div class="header">
        <div class="logo-container">
            ...
            <div class="profile-info">
                <img src="/perfilll2.svg" alt="Maria Duda" class="profile-pic">
                <div class="profile-text">
                    <div class="profile-name">Maria Duda</div>
    ...
    <div class="video-container">
        ...
        <img id="loadingGif" src="/carregando2.gif" alt="Carregando..." style="width: 100%; height: 100%; object-fit: cover; z-index: 2;">
        ...
        <video id="liveVideo" playsinline autoplay muted style="display: none; width: 100%; height: 100%; object-fit: cover; z-index: 1;">
            <source src="/live2.mp4" type="video/mp4">
        </video>
    </div>
