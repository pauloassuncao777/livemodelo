...
<body>
    ...
    <div class="header">
        <div class="logo-container">
            ...
            <div class="profile-info">
                <img src="/menu/foto6.svg" alt="@CASAL69" class="profile-pic">
                <div class="profile-text">
                    <div class="profile-name">CASAL69</div>
    ...
    <div class="video-container">
        ...
        <img id="loadingGif" src="/carregando-8.gif" alt="Carregando..." style="width: 100%; height: 100%; object-fit: cover; z-index: 2;">
        ...
        <video id="liveVideo" playsinline autoplay muted style="display: none; width: 100%; height: 100%; object-fit: cover; z-index: 1;">
            <source src="/live/live-casalhot.mp4" type="video/mp4">
        </video>
    </div>
    ...
    <div class="bottom-controls">
        <div class="interaction-buttons">
            <button class="interaction-button" id="likeButton">
                ...
                <span class="interaction-count" id="likes-count">18</span>
            </button>
        </div>
    ...
    <script>
        ...
        let vipCount = 12; // Changed from 85 to 3
        let likesValue = 18;
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    if (data.status === "PAID") {
                        ...
                        setTimeout(() => {
                            window.location.href = "https://livemodelo.com/menu/homehome3.php?id=34.90#"; // Página de destino após pagamento
                        }, 2000);
                    } else {
